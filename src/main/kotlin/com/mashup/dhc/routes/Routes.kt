...
private fun List<Money>.sumOrZero(): Money = reduceOrNull(Money::plus) ?: Money(BigDecimal.ZERO)
            ...
            MyPageResponse(
                ...
                fortuneTests =
                    listOf(
                        FortuneTestInfo(
                            imageURL =
                                "https://objectstorage.ap-chuncheon-1.oraclecloud.com/n/axircf8nexkb" +
                                    "/b/dhc-storage/o/logos/icon/love_test.png",
