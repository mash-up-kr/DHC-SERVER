...
```json
{
  ...
  "result": {
    ...
    "fortuneTypeImageUrl": "https://.../logos/fortune/wealth/midas.png",
    "graphData": [
  ...
  "rankings": [
    {
      ...
      "result": {
        ...
        "fortuneTypeDescription": "손만 대면 수익이 터지는 사업가",
        "fortuneDetail": "당신은 자본주의 시장에서...",
        "fortuneTypeImageUrl": "https://.../midas.png",
        "graphData": [...],
        "events": [...]
      }
    }
...
### `wealth_fortune` — 금전운 콘텐츠 시드 (500개)
...
| fortuneTypeImageUrl | String | 캐릭터 이미지 URL |
